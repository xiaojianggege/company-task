import formatting from '../untils/formatting'
...
const getData = (data) => {
       ...
       formdata = formatting(formdata, data)
        return fetch('https://trade.aiyongtech.com/aiyongTrade/base.list.get?appName=guanDian&pddApp=guandian&storeId=PDD', {
            body: formdata,
            method: 'post',
            credentials:'include',
        }).then(res => res.json())
            .then( r => r.body.tradeListResponse)
}
